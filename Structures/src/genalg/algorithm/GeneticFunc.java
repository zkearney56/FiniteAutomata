...
import genalg.Population;
import genalg.genomes.ByteGenome;
import genalg.genomes.GeneGenome;
import genalg.genomes.LetterGenome;
import genalg.genomes.TowerGenome;
...
public class GeneticFunc {
	...
	/**
	 * Mutates population. If mutcount < 1, Does not mutate anything. Else,
	 * mutates a random byte based on mutcoef and decrements mutcount until
	 * mutcount is less than 1.
	 * 
	 * @param pop
	 */
	...
	/**
	 * Chooses a random genome from the specified population. The higher the
	 * fitness of the genome, the higher the probability of getting selected.
	 * 
	 * @param pop
	 * @return
	 */
	...
	/**
	 * Finds all elite Genomes from a population and sets the elite population.
	 * 
	 * @param pop
	 * @return
	 */
	...
	/**
	 * Attempts to set a genome as elite, and sorts the elite list by descending
	 * order of fitness.
	 * 
	 * @param pop
	 * @param newElite
	...
	public static void setElite(Population pop, Genome newElite) {
		...
		for (int i = 0; i < elite.size(); i++) {
			if (GeneticFunc.compareGenomes(newElite, elite.get(i)))
				return;
		}
	...
	/**
	 * If an adjust flag is tripped, trims all genomes to length of the
	 * strongest genome with a flipped adjust flag.
	 * 
	 * @param pop
	 */
	...
	/**
	 * Fills an initial population with random genomes.
	 * 
	 * @param pop
	 */
